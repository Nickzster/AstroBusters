Shader "ErbGameArt/LWRP/Particles/Add_DistortTexture"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    half4 frag( GraphVertexOutput IN  ) : SV_Target
		    {
				...
				float4 temp_output_30_0 = ( tex2DNode13 * _Color * IN.ase_color * tex2DNode13.a * _Color.a * IN.ase_color.a );
				...
				#ifdef _USEDEPTH_ON
				float4 staticSwitch47 = ( temp_output_30_0 * clampResult53 );
				#else
				float4 staticSwitch47 = temp_output_30_0;
				#endif			
